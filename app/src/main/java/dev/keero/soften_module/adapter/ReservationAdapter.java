...
public class ReservationAdapter extends RecyclerView.Adapter<ReservationAdapter.ViewHolder> {
    ...
    public ReservationAdapter(ArrayList<Book> dataSet) {
    ...
    @Override
    public void onBindViewHolder(ReservationAdapter.ViewHolder viewHolder, final int position){
